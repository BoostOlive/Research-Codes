...
beduc_ife=betaIFE5(1,1)+2*betaIFE5(2,1)*mean(X1(:));
...
for i=1:N
    ...
    beduc_ifei_fix(1,i)=betaIFEi05(1,i)+2*betaIFEi05(2,i)*mean(X1(:,i));
...
bIFEplincom=betaIFE5(:,1)'*c'
vIFEplincom=c*varcovIFE5(:,:,1)'*c'
...
tstatIFEMGi=betaIFEH5./seIFEi5;
tstatIFEi=betaIFE5./seIFE5;
